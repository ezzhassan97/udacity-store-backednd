...
var orderStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        sql = "INSERT INTO (user_id ) VALUES($1) RETURNING *";
                        return [4 /*yield*/, database_1.default.connect()];
                    case 1:
                        conn = _a.sent();
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("Could not add new order ".concat(o.user_id, ". Error: ").concat(err_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    orderStore.prototype.addProduct = function (quantity, orderId, productId) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, conn, result, order, err_5, sql, conn, result, order, err_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        sql = "SELECT * FROM orders WHERE id=($1)";
                        return [4 /*yield*/, pg_1.Client.connect()];
                    case 1:
                        conn = _a.sent();
