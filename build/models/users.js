        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("Can not get data :".concat(err_1));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        sql = "INSERT INTO (firstname,lastname,username, password_digest) VALUES($1, $2,$3,$4) RETURNING *";
                        return [4 /*yield*/, database_1.default.connect()];
                    case 1:
                        conn = _a.sent();
                        hash = bcrypt_1.default.hashSync(u.password_digest, saltRounds);
                        return [4 /*yield*/, conn.query(sql, [
                                u.firstname,
                                u.lastname,
                                u.username,
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("Could not add new user ".concat(u.username, ". Error: ").concat(err_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (result.rows.length) {
                            user = result.rows[0];
                            console.log(user);
                            if (bcrypt_1.default.compareSync(password, user.password_digest)) {
                                return [2 /*return*/, user];
                            }
                        }
